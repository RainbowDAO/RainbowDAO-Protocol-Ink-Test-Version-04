...
mod multisig {
    ...
    impl Multisig {
        //Account array, minimum multi-signature to execute transactions
        #[ink(constructor)]
        ...
        // #[ink(message)]
        // pub fn get_if(&self,trans_id: u64, addr: AccountId) -> Option<&'a i32> {
        //     self.transactions.get(&trans_id).unwrap().signatures.get(&addr)
        // }
